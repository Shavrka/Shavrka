<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=9D4EDD&center=true&vCenter=true&width=500&lines=Hi+👋+I'm+Mihailo+Blagojević;Привет+👋+Меня+зовут+Михаило+Благоевич;Zdravo+👋+Moje+ime+je+Mihailo+Blagojević;Hallo+👋+I'm+Mihailo+Blagojević;Hola+👋+I'm+Mihailo+Blagojević;Γειά+σου+👋+I'm+Mihailo+Blagojević" alt="Greeting" />
</p>
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=shavrka&label=Profile%20views&color=0e75b6&style=flat" alt="Profile views" />
</p>
...
passion: [Linux Systems, IoT Projects, Web Development, Technical Writing]
currently_learning: [System Design, Cloud Architecture, Go Concurrency]
daily_driver: Fedora Linux + GNOME
available_for: Freelance Projects & Collaboration
```

- 🔌 Electrical Engineering student specializing in **Power Systems & Automation**
- 💻 Technical Computer Science graduate with hands-on development experience
- 🐧 Fedora Linux power user who loves **GNOME** desktop environment
- 🚀 Building scalable web applications with **React**, **Go**, and **Node.js**
- ✍️ Technical writer creating tutorials, documentation, and developer content
- 🌱 Currently exploring **distributed systems** and **cloud architecture**
- 💼 Open for **freelance opportunities** in web development and technical writing
- ⚡ Fun fact: I debug hardware issues as easily as software bugs!
...
<img src="https://skillicons.dev/icons?i=nodejs,go,express" />
<img src="https://skillicons.dev/icons?i=postgres,mongodb,redis" />

#### 📝 Programming Languages
<img src="https://skillicons.dev/icons?i=go,js,ts,c,cpp,python" />
...
Building modern, responsive web applications using React, Next.js, Node.js, and Go. From frontend UI/UX to backend API development and database design.

**🔧 System Administration**  
Expert in Fedora/Linux server configuration, automation scripting (Bash/Go), and Docker containerization for seamless deployments.
...
Creating clear, comprehensive documentation including API references, user guides, tutorials, and professional README files.

**📰 Developer Content**  
Writing engaging blog posts, technical articles, technology comparisons, and detailed code walkthroughs for developer audiences.
...
<img src="PROJECT_SCREENSHOT_URL" width="400" alt="Project 1"/>
</a>
<br/>
<br/>
<p>
...
<img src="https://img.shields.io/badge/Live-green?style=for-the-badge&logo=vercel"/>
</a>
</p>
<p><strong>React, Node.js, MongoDB</strong> - Brief project description goes here</p>
</div>
</td>
<td width="50%">
...
<div align="center">
<a href="PROJECT_LINK" target="_blank">
<img src="PROJECT_SCREENSHOT_URL" width="400" alt="Project 2"/>
</a>
<br/>
<br/>
<p>
...
<p><strong>Next.js, Go, PostgreSQL</strong> - Brief project description goes here</p>
</div>
</td>
</tr>
</table>
...
> 🚀 Coming soon! I'll be publishing technical articles about web development, Linux systems, and programming tutorials.
<!-- BLOG-POST-LIST:END -->
